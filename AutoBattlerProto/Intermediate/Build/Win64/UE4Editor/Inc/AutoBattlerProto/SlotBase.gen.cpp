...
// End Cross Module References
	...
	struct Z_Construct_UFunction_ASlotBase_GetCharacterInSlot_Statics
	{
		struct SlotBase_eventGetCharacterInSlot_Parms
		{
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ASlotBase_GetCharacterInSlot_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SlotBase_eventGetCharacterInSlot_Parms, ReturnValue), Z_Construct_UClass_ACharacterBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ASlotBase_GetCharacterInSlot_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASlotBase_GetCharacterInSlot_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ASlotBase_GetCharacterInSlot_Statics::Function_MetaDataParams[] = {
		{ "Category", "SlotBase" },
		{ "ModuleRelativePath", "SlotBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ASlotBase_GetCharacterInSlot_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASlotBase, nullptr, "GetCharacterInSlot", nullptr, nullptr, sizeof(SlotBase_eventGetCharacterInSlot_Parms), Z_Construct_UFunction_ASlotBase_GetCharacterInSlot_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ASlotBase_GetCharacterInSlot_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ASlotBase_GetCharacterInSlot_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ASlotBase_GetCharacterInSlot_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ASlotBase_GetCharacterInSlot()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ASlotBase_GetCharacterInSlot_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASlotBase_Statics::NewProp_CharacterInSlot = { "CharacterInSlot", nullptr, (EPropertyFlags)0x0040000000020801, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASlotBase, CharacterInSlot), Z_Construct_UClass_ACharacterBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASlotBase_Statics::NewProp_CharacterInSlot_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASlotBase_Statics::NewProp_CharacterInSlot_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASlotBase_Statics::NewProp_CharacterClass_MetaData[] = {
		{ "Category", "Slot Data" },
		{ "ModuleRelativePath", "SlotBase.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_ASlotBase_Statics::NewProp_CharacterClass = { "CharacterClass", nullptr, (EPropertyFlags)0x0024080000010001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASlotBase, CharacterClass), Z_Construct_UClass_ACharacterBase_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_ASlotBase_Statics::NewProp_CharacterClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASlotBase_Statics::NewProp_CharacterClass_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASlotBase_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASlotBase_Statics::NewProp_CharacterClass,
