...
#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_SPARSE_DATA
#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_RPC_WRAPPERS \
 \
 ...
 \
	DECLARE_FUNCTION(execSinAdd) \
	{ \
		P_GET_PROPERTY(UIntProperty,Z_Param_Amount); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=P_THIS->SinAdd(Z_Param_Amount); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSinReduce) \
	{ \
		P_GET_PROPERTY(UIntProperty,Z_Param_Amount); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=P_THIS->SinReduce(Z_Param_Amount); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execStrSet) \
	{ \
		P_GET_PROPERTY(UIntProperty,Z_Param_Amount); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->StrSet(Z_Param_Amount); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execStrReduce) \
	{ \
		P_GET_PROPERTY(UIntProperty,Z_Param_Amount); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=P_THIS->StrReduce(Z_Param_Amount); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execStrAdd) \
	{ \
		P_GET_PROPERTY(UIntProperty,Z_Param_Amount); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=P_THIS->StrAdd(Z_Param_Amount); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execSetCurrentSlot) \
	{ \
		P_GET_OBJECT(ABaseSlot,Z_Param_NewCurrentSlot); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
...
#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_RPC_WRAPPERS_NO_PURE_DECLS \
 \
	DECLARE_FUNCTION(execGetStr) \
	{ \
		P_FINISH; \
...
#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_EVENT_PARMS \
	...
	struct CharacterBase_eventHealthAdded_Parms \
	{ \
		int32 Amount; \
	};


#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_CALLBACK_WRAPPERS
#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_INCLASS_NO_PURE_DECLS \
private: \
...
#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_INCLASS \
private: \
	static void StaticRegisterNativesACharacterBase(); \
	friend struct Z_Construct_UClass_ACharacterBase_Statics; \
public: \
...
#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_STANDARD_CONSTRUCTORS \
...
#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_ENHANCED_CONSTRUCTORS \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ACharacterBase(ACharacterBase&&); \
	NO_API ACharacterBase(const ACharacterBase&); \
...
#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_PRIVATE_PROPERTY_OFFSET \
...
#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_13_PROLOG \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_EVENT_PARMS


#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_GENERATED_BODY_LEGACY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_PRIVATE_PROPERTY_OFFSET \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_SPARSE_DATA \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_RPC_WRAPPERS \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_CALLBACK_WRAPPERS \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_INCLASS \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_STANDARD_CONSTRUCTORS \
public: \
PRAGMA_ENABLE_DEPRECATION_WARNINGS


#define AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_GENERATED_BODY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_PRIVATE_PROPERTY_OFFSET \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_SPARSE_DATA \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_RPC_WRAPPERS_NO_PURE_DECLS \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_CALLBACK_WRAPPERS \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_INCLASS_NO_PURE_DECLS \
	AutoBattlerProto_Source_Lautturi_CharacterBase_h_16_ENHANCED_CONSTRUCTORS \
private: \
PRAGMA_ENABLE_DEPRECATION_WARNINGS
...
#define CURRENT_FILE_ID AutoBattlerProto_Source_Lautturi_CharacterBase_h
